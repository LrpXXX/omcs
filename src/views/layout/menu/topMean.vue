  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logos">
        <a href="/" style="color: #fff;"><span v-show="!$store.state.collapsed">柳汽综合管理</span></a>
      </div>
        ...
        <el-row v-show="$store.state.topNavState==='home'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/ddcs">数据展示中心</el-menu-item>
              <el-menu-item index="/mccs">监控指挥中心</el-menu-item>
              <el-menu-item index="/omcs">运营管理中心</el-menu-item>
              <el-menu-item index="/rmcs">道路管路中心</el-menu-item>
              <el-menu-item index="/sacs">系统管理中心</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner">
            <i class="iconfont icon-user"></i>{{ userInfo.data.userName|| "默认"}}   <i class="el-icon-caret-bottom"></i></span>
